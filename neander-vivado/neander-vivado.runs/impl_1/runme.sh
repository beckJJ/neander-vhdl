...
HD_PWD='C:/Users/beck/projects/neander-vhdl/neander-vivado/neander-vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log neander.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source neander.tcl -notrace

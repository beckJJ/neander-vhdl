...
HD_PWD='C:/Users/beck/projects/neander-vhdl/neander-vivado/neander-vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neander.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neander.tcl
